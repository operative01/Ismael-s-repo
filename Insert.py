...
# URL to scrape
url = "https://marktplaats.insert.nl/materialen/vooraf-vervaardigde-steenachtige-elementen/azobe-balken-fsc-recycled-100-6"
...
collection = db['insert']  # Create or connect to the 'gebruikte_bouwmaterialen' collection
